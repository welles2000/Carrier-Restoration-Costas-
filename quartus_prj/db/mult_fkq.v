//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="YES" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=15 LPM_WIDTHB=15 LPM_WIDTHP=30 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_fkq
	...
	wire signed	[14:0]    dataa_wire;
	wire signed	[14:0]    datab_wire;
	wire signed	[29:0]    result_wire;
	...
	assign result = ({result_wire[29:0]});
