...
# ACDS 16.0 211 win32 2022.02.26.20:29:26
# ----------------------------------------
...
# ----------------------------------------
# If FIR_lpf is one of several IP cores in your
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/dspba_library_package.vhd"                      
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/dspba_library.vhd"                              
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/auk_dspip_math_pkg_hpfir.vhd"                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/auk_dspip_lib_pkg_hpfir.vhd"                    
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/auk_dspip_avalon_streaming_controller_hpfir.vhd"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/auk_dspip_avalon_streaming_sink_hpfir.vhd"      
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/auk_dspip_avalon_streaming_source_hpfir.vhd"    
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/auk_dspip_roundsat_hpfir.vhd"                   
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_avalon_sc_fifo.v"                        
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_lpf_rtl_core.vhd"                           
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_lpf_ast.vhd"                                
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_lpf.vhd"                                    
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_lpf_tb.vhd"                                 
}
