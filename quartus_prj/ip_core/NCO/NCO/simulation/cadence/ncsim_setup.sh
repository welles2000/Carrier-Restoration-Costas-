...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/submodules/NCO_nco_ii_0_sin.hex ./
  cp -f $QSYS_SIMDIR/submodules/NCO_nco_ii_0_cos.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/NCO_nco_ii_0.v" -work nco_ii_0 -cdslib ./cds_libs/nco_ii_0.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/NCO.v"                                                                       
fi
