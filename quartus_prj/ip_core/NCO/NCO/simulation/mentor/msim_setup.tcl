...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/sid_2c_1p.v"        -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/asj_nco_fxx.v"      -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/asj_gar.v"          -work nco_ii_0
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/asj_nco_mob_rw.v"   -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/asj_nco_isdr.v"     -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/segment_arr_tdl.v"  -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/asj_nco_pxx.v"      -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/segment_sel.v"      -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/asj_dxx.v"          -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/asj_xnqg.v"         -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/NCO_nco_ii_0.v"            -work nco_ii_0
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/NCO.v"                                              
}
